...
| P-019 | `POST /admin/rerag` button deferred — `scripts/build_corpus.py` is the must-have (ARCH §10/§7: "script is must-have, button is stretch"); the admin view documents/links the script (Phase 5.2) | corpus-admin polish (Section 7) | n/a (scope; script-not-button by design) |
